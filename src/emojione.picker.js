...
(function ($) {
    $.fn.emojionePicker = function (options) {
        ...
        var createContainer = function (el) {
            $(
                '<div class="' + emojiContainer + '"><nav></nav></div>'
            ).insertAfter(el);
            ...
            $("." + emojiContainer + " nav .tab").click(function () {
            ...
            $(document).off(
                "click",
                "." + emojiContainer + " section .emojione"
            );
            $(document).on(
                "click",
                "." + emojiContainer + " section .emojione",
        ...
        var loadEmojies = function (section) {
            if ($("." + emojiContainer + " section." + section).length > 0) {
                ...
                $("." + emojiContainer + " section")
                    .fadeOut()
                    .promise()
                    .done(function () {
                        $(this).hide();
                        $(
                            "." + emojiContainer + " section." + section
                        ).fadeIn();
            ...
            $(
                '<section class="' + section + '">' + sectionHtml + "</section>"
            ).insertAfter("." + emojiContainer + " nav");
        ...
        var init = (function () {
            ...
            script.onload = function () {
                ...
                $.each($el, function (i, el) {
                    var picker = $(
                        '<div class="emojionepicker-picker" data-index="' +
                            i +
                            '"></div>'
                    ).insertAfter(el);
                    ...
                    picker
                        .css({
                            ...
                            left:
                                $(el).width() +
                                elOffset["left"] -
                                $(".emojionepicker-picker").width() -
                                settings.pickerRight +
                                "px",
                        })
                        .show();
                });
                ...
                $(".emojionepicker-picker").click(function () {
                    ...
                    loadEmojies(
                        $("." + emojiContainer + " nav div.active").attr(
                            "data-tab"
                        )
                    );
                    ...
                    if (pickerOffset["left"] > containerW) {
                        left =
                            pickerOffset["left"] - containerW + $(this).width();
                    } else {
                ...
                $(document).on("click", function (e) {
                    if (
                        $("." + emojiContainer).is(":visible") == false ||
